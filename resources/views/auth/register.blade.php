...
<center><div class="card-header" style="font-weight: bolder;background-color:black;color:white;">{{ __('Register') }}</div>
                    <form method="POST" action="{{ route('register') }}" style="background-color:black;">
                        @csrf

                        <div class="form-group row">
                            <label for="name" class="col-md-4 col-form-label text-md-right" style="font-weight:bolder;color:skyblue;">{{ __('Name') }}</label>
                        ...
                        <div class="form-group row">
                            <label for="password-confirm" class="col-md-4 col-form-label text-md-right" style="font-weight:bolder;color:skyblue;">{{ __('Confirm Password') }}</label>
