...
<div class="w3-border-0" style="height:1000px;width:100%;background-color:hotpink;">
    <center><br><b><font size="+1">DONOUGHT</font></b></center>
     <br><br>
...
@if( $message  = Session::get('success'))
 ...
 @endif
    <form action="/donought" method="post">
       @csrf
      ...
      <table>
        ...
        <tr>
            ...
            <td><select name="snacks">
                <option value="donought">donought</option>
            </select></td>
        </tr>
        <tr>
        <tr>
