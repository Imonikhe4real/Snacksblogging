...
<div class="w3-border-0" style="height:1000px;width:100%;background-color:coral;">
    <center><br><b><font size="+1">MEAT PIE</font></b></center>
     <br><br>
...
@if( $message  = Session::get('success'))
 ...
 @endif
    <form action="/meatpie" method="post">
       @csrf
