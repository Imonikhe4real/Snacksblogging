...
<div class="w3-border-0" style="height:1000px;width:100%;background-color:darkgreen;">
    <center><br><b><font size="+1">Chinese Spring Roll</font></b></center>
     <br><br>
    <center><img src="/img/chinesespringroll.jpeg" style="height:300px;width:80%"></center>
    <br><br>
    <center>
<b style="color:white">@if( $message  = Session::get('success'))
 <div class="alert alert-success">
     <p>{{ $message }}</p>
 </div>
 @endif</b>
    <form action="/springroll" method="post">
       @csrf
