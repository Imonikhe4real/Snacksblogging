...
<div class="w3-border-0" style="height:1000px;width:100%;background-color:yellow;">
    <center><br><b><font size="+1">HOT DOG</font></b></center>
     <br><br>
...
@if( $message  = Session::get('success'))
 ...
 @endif
    <form action="/hotdog" method="post">
       @csrf
