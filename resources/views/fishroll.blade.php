...
<div class="w3-border-0" style="height:1000px;width:100%;background-color:orangered;">
    <center><br><b><font size="+1">FISH ROLL</font></b></center>
     <br><br>
...
@if( $message  = Session::get('success'))
 ...
 @endif
    <form action="/fishroll" method="post">
       @csrf
      ...
      <table>
        ...
        <tr>
            ...
            <td><select name="snacks">
                <option value="fishroll">fishroll</option>
            </select></td>
        </tr>
        <tr>
        <tr>
