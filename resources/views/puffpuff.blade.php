...
<div class="w3-border-0 w3-blue" style="height:1000px;width:100%;">
    <center><br><b><font size="+1">PUFF PUFF</font></b></center>
     <br><br>
...
@if( $message  = Session::get('success'))
 ...
 @endif
    <form action="/puffpuff" method="post">
       @csrf
      ...
      <table>
        ...
        <tr>
            ...
            <td><select name="snacks">
                <option value="puffpuff">puffpuff</option>
            </select></td>
        </tr>
        <tr>
        <tr>
